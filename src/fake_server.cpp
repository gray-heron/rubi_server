...
BoardManager::RequestNewHandler(
  BoardInstance inst,
...
#pragma GCC diagnostic pop
  ...
  board1_fields.push_back(
    make_pair<fields_desc, int>(
      fields_desc("FloatTest", {}, _RUBI_TYPECODES_float, any(666.6f)),
      RUBI_READONLY));
  board1_fields.push_back(
    make_pair<fields_desc, int>(
      fields_desc(
        "StringTest", {}, _RUBI_TYPECODES_shortstring,
  ...
  board2_fields.push_back(
    make_pair<fields_desc, int>(
      fields_desc(
        "FloatTest", {"Subfield1"}, _RUBI_TYPECODES_float,
        any(666.6f)),
      RUBI_READONLY));
  board2_fields.push_back(
    make_pair<fields_desc, int>(
      fields_desc(
        "StringTest", {"Subfield1", "Subfield2"},
        _RUBI_TYPECODES_shortstring, any(string("Hello world"))),
      RUBI_WRITEONLY));
  board2_fields.push_back(
    make_pair<fields_desc, int>(
      fields_desc(
        "IntTest", {"Subfield1", "Subfield", "SuBfIlEd"},
        _RUBI_TYPECODES_int32_t, any(333)),
      RUBI_WRITEONLY));
  board2_fields.push_back(
    make_pair<fields_desc, int>(
      fields_desc(
        "BoolTest", {"Subfield1", "sqi", "SuBfIlEd"},
        _RUBI_TYPECODES_bool, any(0)),
      RUBI_WRITEONLY));

  board3_fields.push_back(
    std::make_pair<fields_desc, int>(
      fields_desc("FloatTest", {}, _RUBI_TYPECODES_float, any(666.6f)),
      RUBI_READONLY));
  board3_fields.push_back(
    std::make_pair<fields_desc, int>(
  ...
  board3_fields.push_back(
    std::make_pair<fields_desc, int>(
      fields_desc(
        "StringTest2", {}, _RUBI_TYPECODES_shortstring,
